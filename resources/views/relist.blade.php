        ...
        <div class="card shadow-sm my-2 p-3">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    @if ($advert->lodge_id !== null)
                        <form action="{{ route('update-relist-lodge', $advert->uuid) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="mb-3">
                            ...
                            <button class=" btn btn-primary btn-lg mx-auto w-100">Proceed to re-list this lodge</button>
                        </form>
                    @else
                        <form action="{{ route('update-relist-service', $advert->uuid) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="mb-3">
                            ...
                            <button class=" btn btn-primary btn-lg mx-auto w-100">Proceed to re-list this service</button>
                        </form>
                    @endif
