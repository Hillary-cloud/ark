    ...
    <div class="container">
        <div class="card w-100 m-3 shadow-sm p-2">
            <div class="d-flex justify-content-between">
                ...
                <a href="{{route('admin.service')}}" class="btn btn-success rounded-pill text-light p-1" style="width: 12rem">All Service</a>
            </div>
        </div>
        ...
        @endif
            <form action="{{route('admin.store-service')}}" method="POST" class="p-3">
                @csrf
